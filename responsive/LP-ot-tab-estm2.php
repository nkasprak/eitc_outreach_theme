 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - estm2
 *
 * @file           LP-ot-tab-estm2.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-estm2.php
...
<!-- Formula for Married with 2 Kids -->

	if (EARNINGS < 13430){EITC = Math.round(100*(EARNINGS * .4)/100)}

	if (EARNINGS > 13429)
	if (EARNINGS < 22870){EITC = 5372}

	if (EARNINGS > 22869)
	if (EARNINGS < 48378){EITC = Math.round(100*(5372 - (.2106 * (EARNINGS - 22870)))/100)};

	if (EARNINGS > 48378){EITC = "Not Eligible"}
