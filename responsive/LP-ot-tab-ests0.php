 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - ests0
 *
 * @file           LP-ot-tab-ests0.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-ests0.php
...
<!-- Formula for Single with 0 Kids -->

	if (EARNINGS < 6370){EITC = Math.round(100*(EARNINGS * .0765)/100)}

	if (EARNINGS > 6369)
	if (EARNINGS < 7970){EITC = 487}

	if (EARNINGS > 7969)
	if (EARNINGS < 14340){EITC = Math.round(100*(487 - (.0765 * (EARNINGS - 7970)))/100)};

	if (EARNINGS > 14340){EITC = "Not Eligible"}
