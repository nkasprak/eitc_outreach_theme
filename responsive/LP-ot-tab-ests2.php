 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - ests2
 *
 * @file           LP-ot-tab-ests2.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-ests2.php
...
<!-- Formula for Single with 2 Kids -->

	if (EARNINGS < 13430){EITC = Math.round(100*(EARNINGS * .4)/100)}

	if (EARNINGS > 13429)
	if (EARNINGS < 17530){EITC = 5372}

	if (EARNINGS > 17529)
	if (EARNINGS < 43038){EITC = Math.round(100*(5372 - (.2106 * 
         (EARNINGS - 17530)))/100)};

	if (EARNINGS > 43038){EITC = "Not Eligible"}
