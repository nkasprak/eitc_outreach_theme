 ...
 *
 *
 * @file           sidebar-right-custom.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2013 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/sidebar-right-custom.php
...
<!--attempting to list child pages of grandparent-->
		...
		<?php
		  if($post->post_parent) {
		  $children = wp_list_pages("title_li=&child_of=".$post->ancestors[1]."&hierarchical=0&parent=".$post->ancestors[1]."&echo=0");
		  }
