 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - ests1
 *
 * @file           LP-ot-tab-ests1.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-ests1.php
...
<!-- Formula for Single with 1 Kid -->

	if (EARNINGS < 9560){EITC = Math.round(100*(EARNINGS * .34)/100)}

	if (EARNINGS > 9559)
	if (EARNINGS < 17530){EITC = 3250}

	if (EARNINGS > 17529)
	if (EARNINGS < 37870){EITC = Math.round(100*(3250 - (.1598 * (EARNINGS - 17530)))/100)};

	if (EARNINGS > 37870){EITC = "Not Eligible"}
