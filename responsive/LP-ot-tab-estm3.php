 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - estm3
 *
 * @file           LP-ot-tab-estm3.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-estm3.php
...
<!-- Formula for Married with 3+ Kids -->
	if (EARNINGS < 13430){EITC = Math.round(100*(EARNINGS * .45)/100)}

	if (EARNINGS > 13429)
	if (EARNINGS < 22870){EITC = 6044}

	if (EARNINGS > 22869)
	if (EARNINGS < 51567){EITC = Math.round(100*(6044 - (.2106 * (EARNINGS - 22870)))/100)};

	if (EARNINGS > 51567){EITC = "Not Eligible"}
