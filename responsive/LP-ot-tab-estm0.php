 ...
 * Landing Page Template
   ...
   Template Name:  LP - Outreach Tools - TAB - estm0
 *
 * @file           LP-ot-tab-estm0.php
 * @package        Responsive 
 * @author         Emil Uzelac 
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/LP-ot-tab-estm0.php
...
<!-- Formula for Married with 0 Kids -->

	if (EARNINGS < 6370){EITC = Math.round(100*(EARNINGS * .0765)/100)}

	if (EARNINGS > 6369)
	if (EARNINGS < 13310){EITC = 487}

	if (EARNINGS > 13309)
	if (EARNINGS < 19680){EITC = Math.round(100*(487 - (.0765 * (EARNINGS - 13310)))/100)};

	if (EARNINGS > 19680){EITC = "Not Eligible"}
